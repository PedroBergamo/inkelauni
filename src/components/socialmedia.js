    ...
    render() {
        return (
          ...
          <Nav.Link
            ...
            >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <Nav.Link
            href="https://www.facebook.com/inkelauni"
            target="_blank"
            alt="Facebook"
            style={navObj.linkStyle}
                    >
